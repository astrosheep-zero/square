...
export function pendingDeliveriesFromState(state: SquareState): readonly PendingDeliveryProjection[] {
...
export async function pendingDeliveries(square: OpenSquare): Promise<readonly PendingDeliveryProjection[]> { const { state } = await square.cell.read(); return pendingDeliveriesFromState(state); }
