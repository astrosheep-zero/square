...
const COMMANDS: readonly CommandHelp[] = [
  ...
  {
    names: ['express'], usage: '--as <name> express [-f|--force] [--no-wait] [--beside <name> | --bell] [--reply <act_N>] [--require-ack] <activity | ->', usesSquare: true, group: 'participant',
    summary: 'Speak, gesture, or do both.',
    details: ['Options:', '  -f, --force       Express without first catching unread activity.', '  --no-wait         If held or throttled, save a draft and return.', '  --beside <name>   Speak aside to one participant.', "  --bell            Call every participant's attention to this activity.", '  --reply <act_N>   Mark this activity as a reply to an earlier activity.', '  --require-ack    Re-wake at most twice until the recipient catches it.'],
  },
  {
